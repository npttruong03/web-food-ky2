...
// subtotal.innerHTML = (parseFloat(price.innerHTML) * qty.value).toLocaleString('it-IT', {style : 'currency', currency : 'VND'});
// price.innerHTML = parseFloat(price.innerHTML).toLocaleString('it-IT', {style : 'currency', currency : 'VND'});
